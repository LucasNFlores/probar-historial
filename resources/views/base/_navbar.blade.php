    ...
    <div class="flex flex-wrap items-center">
        ...
        <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
            <span class="relative w-full">
                <input aria-label="search" type="search" id="search" placeholder="Buscar" class="w-full bg-neutral-600	 text-white transition border border-transparent focus:outline-none focus:border-orange-500 rounded py-3 px-2 pl-10 appearance-none leading-normal">
