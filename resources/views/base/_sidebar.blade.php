            ...
            <nav aria-label="alternative nav  " class="bg-gradient-to-r from-orange-500 to-orange-500 ">
                <div class="bg-gradient-to-r from-orange-500 to-orange-500 h-20 fixed bottom-0 pt-8 md:relative md:h-screen z-10 w-full md:w-48 content-center  ">
                    <div class=" md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                        ...
                        @if(auth()->user()->can('apiaries.index')&&('hives.index')&&('devices.index'))
                            <li class="mr-3 flex-1 ">
                        ...
                        @if(auth()->user()->can('variables.index')&&('data.index')&&('users.index'))
                            <li class="mr-3 flex-1">
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{route('users.index')}}" class="flex items-center block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2  border-gray-200 hover:border-black ">
                                    <span class="material-icons pr-0 md:pr-3 text-white-600 pr-2">manage_accounts</span><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Usuarios</span>
                                </a>
