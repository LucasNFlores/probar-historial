        ...
        <div class="flex flex-col md:flex-row">
            <nav aria-label="alternative nav">
                <div class="bg-zinc-900 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                        ...
                        <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                            ...
                            <li class="mr-3 flex-1 ">
                                <a href="{{route('apiaries.index')}}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-orange-500 ">
                                    <span class="material-symbols-outlined">inventory_2</span><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Apiarios</span>
                                </a>
                            </li>
                            <li class="mr-3 flex-1">
