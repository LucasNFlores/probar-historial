...
<div class="py-10 min-h-screen w-screen antialiased font-medium text-gray-800 bg-slate-100 bg-white" x-data="{ modal: true }">
    ...
    >
            <div class="relative p-6">
                ...
                <h1 class="text-3xl font-bold text-center">¡Atención!</nav></h1>
                <p class="text-sm text-gray-500 text-center mt-3">Está por eliminar esta colmena</p>
                <code>App/Cokies</code>
                <div class="flex flex-row mt-6 space-x-2 justify-evenly">
                    <a href="#" class="w-full py-3 text-sm font-medium text-center text-white transition duration-150 ease-linear bg-red-600 border border-red-600 rounded-lg hover:bg-red-500">Confirmar</a>
